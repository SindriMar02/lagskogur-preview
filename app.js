...
const PATTERNS = {
  ...
  /* the card starts at a third of its size; a title counter-scaled by 3 would read as
     constant but is wider than the small card and clips, so it grows from ~half */
  landingExpansiveCardText: { measure: 'closest:.section', keys: () => [{ v: 0, e: 0, p: { transform: 'scale(1.4)' } }, { v: -60, e: 0, p: { transform: 'scale(1)' } }], easing: 'easeInOutQuad', clamp: true },
